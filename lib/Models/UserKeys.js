(function() {
  ...
  UserKeys = (function(superClass) {
    ...
    function UserKeys() {
      this.delKey = bind(this.delKey, this);
    ...
    UserKeys.prototype.addKey = function(userId, title, key, fn) {
      ...
      return this.post("users/" + userId + "/keys", params, function(err, data) {
        if (fn) {
          return fn(err, data);
        }
      });
    ...
    UserKeys.prototype.delKey = function(userId, keyId, fn) {
      if (fn == null) {
        fn = null;
      }
      return this["delete"]("users/" + userId + "/keys/" + keyId, function(err, result) {
        if (fn) {
