(function() {
  ...
  Groups = (function(superClass) {
    ...
    Groups.prototype.addMember = function(groupId, userId, accessLevel, fn) {
      ...
      return this.post("groups/" + (parseInt(groupId)) + "/members", params, function(err, data) {
        if (fn) {
          return fn(err, data);
        }
      });
    ...
    Groups.prototype.create = function(params, fn) {
      ...
      return this.post("groups", params, function(err, data) {
        if (fn) {
          return fn(err, data);
        }
      });
    ...
    Groups.prototype.addProject = function(groupId, projectId, fn) {
      ...
      return this.post("groups/" + (parseInt(groupId)) + "/projects/" + (parseInt(projectId)), null, function(err, data) {
        if (fn) {
          return fn(err, data);
        }
      });
