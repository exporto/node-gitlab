(function() {
  ...
  Users = (function(superClass) {
    ...
    function Users() {
      ...
      this.tokens = bind(this.tokens, this);
    ...
    Users.prototype.tokens = function(userId, fn) {
      if (fn == null) {
        fn = null;
      }
      this.debug("Users::tokens(" + userId + ")");
      return this.get("users/" + (parseInt(userId)) + "/impersonation_tokens", (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
    ...
    Users.prototype.createToken = function(userId, tokenName, fn) {
      var params;
      if (fn == null) {
        fn = null;
      }
      this.debug("Users::createToken(" + userId + ", " + tokenName + ")");
      params = {
        user_id: userId,
        name: tokenName,
        scopes: ["api", "read_user"]
      };
      return this.post("users/" + (parseInt(userId)) + "/impersonation_tokens", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
